 ...
 * @author t.k
 */
public class javadbsousakadai7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
                ...
                try {
                    ...
                    ps1 = conn.prepareStatement("update profiles set name = ?, age = ?, birthday = ? where profilesID = ?");
                    ps1.setString(1,"松岡 修造");//?  
                    ps1.setInt(2,48);
                    ps1.setString(3,"1967-11-06");
                    ps1.setInt(4,1);
                    ps1.executeUpdate();
